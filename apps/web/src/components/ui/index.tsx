...
export function EmptyState({
  ...
  return (
    <div className={clsx('flex flex-col items-center justify-center gap-3 text-center', className)}>
...
export function Modal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div
        className={clsx(
          'relative w-full bg-white rounded-2xl shadow-2xl animate-slide-up max-h-[90vh] flex flex-col',
          sizeClasses[size],
        )}
      >
        ...
        {Array.from({ length: Math.min(5, totalPages) }, (_, i) => {
          ...
          return (
            <button
              ...
              className={clsx(
                'btn btn-sm px-3 min-w-[36px]',
                p === page ? 'bg-brand-600 text-white hover:bg-brand-700' : 'btn-secondary',
              )}
            >
              {p}
            </button>
