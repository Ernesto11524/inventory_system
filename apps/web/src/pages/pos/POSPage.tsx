      ...
      <div className="flex-1 flex flex-col bg-gray-50 overflow-hidden border-r border-gray-200">
        <div className="p-3 bg-white border-b border-gray-200 space-y-2 shrink-0">
          {(user?.role === 'admin' || user?.role === 'manager') ? (
            ...
            <button onClick={() => setShowHistory(true)} className="text-xs text-brand-600 font-medium flex items-center gap-1 hover:text-brand-700">
              <History size={11} /> My Recent Sales (last 50)
            </button>
          )}
