      ...
      <div className="grid grid-cols-2 gap-3">
        ...
        <div>
                  ...
                  try {
                    ...
                    if (data.status === 1 && data.product) {
                      ...
                      if (name) {
                        ...
                        toast("Product found but no name available", {
                          icon: "⚠️",
                        });
                      }
                    } else {
                      toast(
                        "Product not found in database — please type name manually",
                        { icon: "ℹ️" },
                      );
                    }
                  } catch {
          ...
          <p className="text-xs text-gray-400 mt-1">
            Scan barcode and press Enter to auto-fill product name
          </p>
        </div>
        ...
        <div>
          ...
          />
          <p className="text-xs text-gray-400 mt-1">
            If left blank, profit calculations will show GH₵0 for this product
          </p>
        </div>
...
export function ProductsPage() {
  ...
  const { data, isLoading } = useQuery({
    ...
    queryFn: () =>
      get<Product[]>("/products", { page, limit: 20, search, categoryId }),
  });
                  ...
                  >
                    ...
                    <td className="py-3 px-4 text-right">
                      ...
                      <p className="text-xs text-gray-400">
                        Cost: GH₵{Number(product.costPrice).toFixed(2)}
                      </p>
                    </td>
