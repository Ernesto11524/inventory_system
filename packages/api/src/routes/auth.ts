 ...
 *                 type: string
 */
authRouter.post('/login', authLimiter, validate(loginSchema), async (req: Request, res: Response, next) => {
  try {
 ...
 *     security: []
 */
authRouter.post('/refresh', validate(refreshTokenSchema), async (req: Request, res: Response, next) => {
  try {
 ...
 *     tags: [Auth]
 */
authRouter.get('/me', authenticate, async (req: Request, res: Response, next) => {
  try {
